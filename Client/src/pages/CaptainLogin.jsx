  ...
  return (
    <div className='w-full h-screen flex flex-col'>
      ...
      <form className='flex flex-col gap-5 p-5' onSubmit={(e) => { submitHadelar(e) }}>
        ...
        <label className='text-xl font-medium' htmlFor="password">Enter password</label>
      ...
      <p className='pl-5 pr-5 w-full flex justify-center gap-2'>
        New to Uber? <Link to={"/captain-signup"} className='text-blue-400 no-underline hover:underline'>Create an account</Link>
      </p>
    </div>
  )
}
