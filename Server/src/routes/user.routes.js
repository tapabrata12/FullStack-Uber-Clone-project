...
const authUserToken = require('../middlewares/auth.userToken');
const userLogout = require('../controllers/user.logout.controller');
...
router.get('/logout', authUserToken,userLogout);
